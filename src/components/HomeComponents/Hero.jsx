  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4 mt-10 w-full sm:w-auto">
        ...
        <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-white border border-zinc-300 text-zinc-800 font-bold hover:bg-zinc-50 transition-all shadow-sm hover:scale-105">
          View Architecture
